...
public class defendantnewcase extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         if(nametf1.getText().trim().isEmpty()){
          JOptionPane.showMessageDialog(defendantnewcase.this, "Please Enter Name");
      }
      else{
        String name=nametf1.getText();
       
       File myFile=new File("C:\\Users\\Ashwanth R Kumar\\Documents\\Lawyers Files\\"+name+".txt");
       try{
           
                
       if(myFile.createNewFile())
       {
          JOptionPane.showMessageDialog(defendantnewcase.this, "Case "+name+" successfully created");
          FileWriter myWrite=new FileWriter("C:\\Users\\Ashwanth R Kumar\\Documents\\Lawyers Files\\"+name+".txt");
          myWrite.write("Defendant \n");
                    myWrite.write("Name: "+name+"\n");
                    myWrite.write("Phone No.: "+nametf.getText()+"\n");
                    myWrite.write("Case Information: "+infota.getText()+"\n");
                    myWrite.write("===================================================\n");
                    myWrite.write("===================RECORDS=========================\n");
                    myWrite.write("===================================================\n");
                    myWrite.close();
                    File file = new File("C:\\Users\\Ashwanth R Kumar\\Documents\\Lawyers Files\\all.txt");
                    FileWriter allWrite = new FileWriter(file, true);
                    allWrite.write(name+"\n");
                    allWrite.close();
           ...
           JOptionPane.showMessageDialog(defendantnewcase.this, "Case already exists");
       }catch(IOException e)
       {
           JOptionPane.showMessageDialog(defendantnewcase.this, "Error");
       }
      }
